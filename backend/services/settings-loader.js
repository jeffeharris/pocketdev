...
export class SettingsLoader {
  ...
  async loadGitHubIntegration() {
    ...
    if (githubFromFile) {
      ...
      console.log(
        "[SettingsLoader] GitHub integration enabled from settings file",
      );
      return this.github;
    }
    ...
    if (githubFromEnv) {
      ...
      console.log(
        "[SettingsLoader] GitHub integration enabled from environment",
      );
      return this.github;
    }
  ...
  async loadAllSettings() {
    ...
    try {
      ...
      console.log(
        "[SettingsLoader] No settings file found or error loading:",
        error.message,
      );
    }
  ...
  async _loadGitHubFromDatabase() {
    try {
      ...
      console.error(
        "[SettingsLoader] Error loading GitHub token from database:",
        error.message,
      );
      return null;
    }
  ...
  _loadGitHubFromEnvironment() {
    if (this.config.githubToken) {
      return new GitHubService(this.config.githubToken);
    }
    return null;
  }
