import type { Task, CreateTaskDTO } from '../types/task.ts';
import { TaskState, WorkerStatus } from '../types/task.ts';
import type { GitStatus, ChangedFile, PullRequest } from '../types/git.ts';
import type { DeploymentResult } from '../types/container.ts';
import type { Project } from '../types/project.ts';
import type { Settings, UpdateSettingsDTO, GithubTestResult } from '../api/settings.ts';
import { mockTasks, mockProjects, mockGitStatus, mockChangedFiles } from './mockData.ts';
